...
// the next visit.
const CACHE_VERSION = 'jlptsuccess-n4-v1';
...
const PRECACHE = [
  ...
  './data/grammar.json',
  './data/questions.json',
  './data/n4_kanji_whitelist.json',
  './data/n4_kanji_readings.json',
  './data/n4_vocab_whitelist.json',
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    let kanjiSvgs = [];
    try {
      const wlResp = await fetch('./data/n4_kanji_whitelist.json', { cache: 'reload' });
      if (wlResp.ok) {
