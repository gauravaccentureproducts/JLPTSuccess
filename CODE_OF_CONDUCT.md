...
- **Email** the maintainer at `gaurav.l.srivastava@accenture.com` with the subject line prefixed `[JLPTSuccess COC]`.
- Include: what happened, who was involved, when (link to comment / commit / issue if applicable), and any context the maintainer should know.
- Reports are handled confidentially. The reporter will receive an acknowledgment within 7 days.

If the report concerns the maintainer themselves, escalate through GitHub's [content-reporting flow](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam) instead.
...
- The GitHub repository (issues, PRs, discussions, code, commit messages)
- Any project-affiliated communication channel (email threads tagged with the project, future Discord / Slack / etc. if any are created)
...
This Code of Conduct is the Contributor Covenant v2.1 by reference. The full text and translations are at https://www.contributor-covenant.org/.
