...
about: Suggest a new feature, surface, or improvement that doesn't fit a bug or content correction.
title: "[feature] "
...
<!-- One sentence. E.g. "Add a kanji-by-radical search filter on the kanji index page." -->

## Why this matters

<!-- The user need or learning gap this addresses. Be concrete: who benefits, in what scenario, and what they currently can't do? -->

## Niche fit (optional but useful)
...
<!-- A few things JLPTSuccess deliberately won't do (per project decisions). Make sure your request isn't one of these: -->
...
<!-- Does another JLPT-prep app already do this well? (Bunpro, WaniKani, Renshuu, JLPT Sensei, Anki, Memrise, etc.) Linking the reference helps a lot. -->

## Effort + impact estimate (optional)

- **Estimated effort:** small / medium / large / unknown
- **Estimated impact:** how many users benefit / how often is the surface visited
