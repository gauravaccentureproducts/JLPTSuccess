...
**Version:** v1.12.50 (post-round-9 close-out + listening multi-voice render)
**Built at:** see `data/version.json` (regenerated by `tools/build_version_json.py`)
**Last updated:** 2026-05-07 (round-9 audit fully closed; all 219 audit items Done)
...
`tools/check_content_integrity.py` runs **48 named invariants** (counted as PASS in the v1.12.50 build). Categories:
...
- **JA-1 to JA-39** — Japanese-content + scope-discipline rules. Highlights of additions since round-4:
