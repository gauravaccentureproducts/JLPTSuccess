import{renderJa as s}from"./furigana.js";import*as f from"./storage.js";import{hasAlignedTranscript as $,renderTranscriptHTML as h,wireTranscriptSync as v}from"./listening-transcript.js";let l=null,c=null;const g={task:"\u304B\u3060\u3044\u308A\u304B\u3044 (\u30BF\u30B9\u30AF\u308A\u304B\u3044)",point:"\u30DD\u30A4\u30F3\u30C8\u308A\u304B\u3044",utterance:"\u306F\u3064\u308F\u3072\u3087\u3046\u3052\u3093"};async function y(){if(l)return l;try{const i=await fetch("data/listening.json");if(!i.ok)return l={items:[]},l;l=await i.json()}catch{l={items:[]}}return l}async function j(i){return await y(),c?m(i):u(i)}function u(i){const e=l.items||[];if(e.length===0){i.innerHTML=`
      <h2>${s("\u3061\u3087\u3046\u304B\u3044 \u308C\u3093\u3057\u3085\u3046")}</h2>
