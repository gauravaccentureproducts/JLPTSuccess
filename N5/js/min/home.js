import*as a from"./storage.js";import{t as r,currentLocale as T}from"./i18n.js";let v=null,w=null;async function C(){if(v)return v;const e=["grammar","vocab","kanji","reading","listening"].map(t=>fetch(`data/${t}.json`).then(l=>l.ok?l.json():null).catch(()=>null)),[c,p,m,u,d]=await Promise.all(e),n=(t,...l)=>{if(!t)return 0;for(const h of l)if(Array.isArray(t[h]))return t[h].length;return 0};if(v={grammar:n(c,"patterns"),vocab:n(p,"entries"),kanji:n(m,"entries"),reading:n(u,"passages"),listening:n(d,"items")},c&&Array.isArray(c.patterns)){w={};for(const t of c.patterns){if(!t?.id)continue;const l=t.pattern||t.name||t.meaning_en||"";w[t.id]=l?`${t.id} - ${l}`:t.id}}return v}const o=s=>{const e=T()==="hi"?"hi-IN":"en-US";return Intl.NumberFormat(e).format(s||0)};function L(s){const e=a.getHistory(),c=a.getKnownKanji?a.getKnownKanji():{},p=a.getKnownVocab?a.getKnownVocab():{},m=a.getResults(),u=Object.values(e).filter(y=>y&&(y.isMastered||y.isManuallyKnown)).length,d=Object.keys(p).length,n=Object.keys(c).length,t=a.getCompletedReading?a.getCompletedReading():{},l=a.getCompletedListening?a.getCompletedListening():{},h=Object.keys(t).length,$=Object.keys(l).length,b=m.length?m[m.length-1]:null;return{grammar:{done:u,total:s.grammar},vocab:{done:d,total:s.vocab},kanji:{done:n,total:s.kanji},reading:{done:h,total:s.reading},listening:{done:$,total:s.listening},mockTest:b?{done:b.correct,total:b.total,percent:b.percent}:{done:0,total:0,percent:null,notAttempted:!0}}}function P(s){return[{idx:"01",id:"grammar",title:"Grammar",count:`${o(s.grammar)} patterns`,desc:"Basic sentence structure, particles, verb forms, adjectives, comparison, requests, and common N5 expressions.",href:"#/learn/grammar",action:"Open Grammar Syllabus"},{idx:"02",id:"vocab",title:"Vocabulary",count:`${o(s.vocab)} words`,desc:"Daily life words, time expressions, family, food, school, travel, verbs, adjectives, and common expressions.",href:"#/learn/vocab",action:"Open Vocabulary List"},{idx:"03",id:"kanji",title:"Kanji",count:`${o(s.kanji)} characters`,desc:"Numbers, time, people, school, directions, nature, common verbs, and basic recognition kanji.",href:"#/kanji",action:"Open Kanji List"},{idx:"04",id:"reading",title:"Reading",count:`${o(s.reading)} passages`,desc:"Short notices, simple messages, daily-life paragraphs, and basic comprehension practice.",href:"#/reading",action:"Start Reading Practice"},{idx:"05",id:"listening",title:"Listening",count:`${o(s.listening)} drills`,desc:"Greetings, classroom phrases, daily conversations, time, shopping, directions, and simple Q&A.",href:"#/listening",action:"Start Listening Practice"},{idx:"06",id:"test",title:"Mock Test",count:"15 questions",desc:"Auto-scored mock test with correct answers, explanations, and weak-area review.",href:"#/test",action:"Take Mock Test"}]}const K=[{text:"Learn basic sentence structure and particles",href:"#/learn/grammar"},{text:"Study core vocabulary",href:"#/learn/vocab"},{text:"Learn basic kanji recognition",href:"#/kanji"},{text:"Practice grammar questions",href:"#/drill"},{text:"Practice short reading passages",href:"#/reading"},{text:"Practice listening drills",href:"#/listening"},{text:"Take the mock test",href:"#/test"},{text:"Review weak areas",href:"#/review"}];function D(s){return`
  ...
  `}function g(s){return String(s??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}export{A as renderHome};
