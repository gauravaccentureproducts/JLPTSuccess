import{renderJa as N}from"./furigana.js";import*as C from"./storage.js";import{esc as r,wireExpandCollapseControls as T}from"./learn.js";import{currentLocale as $}from"./i18n.js";import{renderItemBadge as I}from"./provenance-badge.js";function P(a,n){if(!a||!Number.isFinite(a.mora))return"";const l=a.mora,t=a.drop;let i="";for(let e=1;e<=l;e++)t===0?i+=e===1?"L":"H":t===1?i+=e===1?"H":"L":i+=e===1?"L":e<=t?"H":"L";return i}function V(a){return{satsu:"\u3055\u3064",dai:"\u3060\u3044",hiki:"\u3072\u304D",wa:"\u308F",mai:"\u307E\u3044",ken:"\u3051\u3093",hon:"\u307B\u3093",soku:"\u305D\u304F",ko:"\u3053",nin:"\u306B\u3093",tsu:"\u3064",kai:"\u304B\u3044",do:"\u3069",fun:"\u3075\u3093",ji:"\u3058"}[a]||a}const S={be:{humble:{ja:"\u304A\u308B",reading:"\u304A\u308B",gloss:"to exist (humble; said about self / in-group)"},respectful:{ja:"\u3044\u3089\u3063\u3057\u3083\u308B",reading:"\u3044\u3089\u3063\u3057\u3083\u308B",gloss:"to exist (respectful; said about social superiors)"},note_en:'\u3044\u308B has both humble (\u8B19\u8B72\u8A9E: \u304A\u308B) and respectful (\u5C0A\u656C\u8A9E: \u3044\u3089\u3063\u3057\u3083\u308B) keigo forms. The respectful \u3044\u3089\u3063\u3057\u3083\u308B also covers "go" and "come" (see chains go / come).'},go:{humble:{ja:"\u53C2\u308B",reading:"\u307E\u3044\u308B",gloss:"to go / come (humble)"},respectful:{ja:"\u3044\u3089\u3063\u3057\u3083\u308B",reading:"\u3044\u3089\u3063\u3057\u3083\u308B",gloss:"to go / come / be (respectful)"},note_en:'\u884C\u304F maps to humble \u53C2\u308B and respectful \u3044\u3089\u3063\u3057\u3083\u308B. The respectful \u3044\u3089\u3063\u3057\u3083\u308B is shared with "come" and "be" (one form, three meanings).'},eat:{humble:{ja:"\u3044\u305F\u3060\u304F",reading:"\u3044\u305F\u3060\u304F",gloss:"to eat / receive (humble; also said before meals as \u3044\u305F\u3060\u304D\u307E\u3059)"},respectful:{ja:"\u53EC\u3057\u4E0A\u304C\u308B",reading:"\u3081\u3057\u3042\u304C\u308B",gloss:"to eat (respectful; offered to the listener)"},note_en:'\u98DF\u3079\u308B has the humble form \u3044\u305F\u3060\u304F (also a courtesy expression before meals) and the respectful \u53EC\u3057\u4E0A\u304C\u308B (used when offering food: \u304A\u53EC\u3057\u4E0A\u304C\u308A\u304F\u3060\u3055\u3044 = "please eat").'},see:{humble:{ja:"\u62DD\u898B\u3059\u308B",reading:"\u306F\u3044\u3051\u3093\u3059\u308B",gloss:"to see / look at (humble)"},respectful:{ja:"\u3054\u89A7\u306B\u306A\u308B",reading:"\u3054\u3089\u3093\u306B\u306A\u308B",gloss:"to see / look at (respectful)"},note_en:"\u898B\u308B's humble \u62DD\u898B\u3059\u308B is used when viewing something a superior gave/showed you (e.g. \u5199\u771F\u3092\u62DD\u898B\u3057\u307E\u3057\u305F). \u5FA1\u89A7\u306B\u306A\u308B is offered to a superior (\u304A\u5199\u771F\u3092\u5FA1\u89A7\u306B\u306A\u308A\u307E\u3059\u304B)."},say:{humble:{ja:"\u7533\u3059",reading:"\u3082\u3046\u3059",gloss:"to say (humble; common in self-introductions)"},respectful:{ja:"\u304A\u3063\u3057\u3083\u308B",reading:"\u304A\u3063\u3057\u3083\u308B",gloss:"to say (respectful)"},note_en:`\u8A00\u3046's humble \u7533\u3059 appears in self-intros (\u9234\u6728\u3068\u7533\u3057\u307E\u3059 = "I am called Suzuki"). Respectful \u304A\u3063\u3057\u3083\u308B is used when quoting a superior's words (\u5148\u751F\u304C\u304A\u3063\u3057\u3083\u3063\u305F).`},do:{humble:{ja:"\u3044\u305F\u3059",reading:"\u3044\u305F\u3059",gloss:"to do (humble)"},respectful:{ja:"\u306A\u3055\u308B",reading:"\u306A\u3055\u308B",gloss:"to do (respectful)"},note_en:"\u3059\u308B maps to humble \u3044\u305F\u3059 and respectful \u306A\u3055\u308B. Common in customer-service speech: \u304A\u96FB\u8A71\u3044\u305F\u3057\u307E\u3059 (I will call) / \u4F55\u306B\u306A\u3055\u3044\u307E\u3059\u304B (what would you like)."}};function E(a){const n=S[a.register_chain_id];if(!n)return"";const l=a.form,t=a.reading||"",i=a.gloss||"",e=p=>String(p??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c]);return`
  ...
  `,T(a,"details.vocab-section");const v=document.getElementById("vocab-filter-q");v&&v.addEventListener("input",()=>{y=v.value,F(a,n);const s=document.getElementById("vocab-filter-q");if(s){s.focus();const o=s.value;s.setSelectionRange(o.length,o.length)}})}function G(a,n,l,t){const i=n.entries||[],e=i.find(s=>s.form===t);if(!e){a.innerHTML=`
    ...
    `;return}const p=new Set,c=[];for(const s of l.patterns||[]){for(const o of s.examples||[]){if(!o.ja||o.ja.includes("(see ")||p.has(o.ja))continue;let g=!1;if(Array.isArray(o.vocab_ids))g=o.vocab_ids.includes(e.id);else{const u=[t];e.reading&&e.reading!==t&&u.push(e.reading),g=u.some(w=>o.ja.includes(w))}if(g&&(p.add(o.ja),c.push({ja:o.ja,en:o.translation_en,source:s.pattern}),c.length>=24))break}if(c.length>=24)break}c.sort((s,o)=>(s.ja?.length||0)-(o.ja?.length||0));const m=c.slice(0,5),d=L(i),h=d.findIndex(s=>s.id===e.id),f=h>0?d[h-1]:null,b=h>=0&&h<d.length-1?d[h+1]:null,v=C.isVocabKnown(e.form);a.innerHTML=`
    <article class="vocab-detail">
      <a class="back-link" href="#/learn/vocab">\u2190 Back to Vocabulary</a>
      <header class="vocab-header pattern-header">
        <div>
          ...
          <p class="vocab-gloss-big">${r(k(e))} ${I(e,!0)}</p>
        </div>
      ...
      <section>
        ...
        ${(()=>{const s=[];return e.pitch_accent&&Number.isFinite(e.pitch_accent.mora)&&s.push(`<p><strong>Pitch accent:</strong> <span class="vocab-pitch" lang="ja">${r(P(e.pitch_accent,e.reading))}</span> <span class="muted small">(drop: ${e.pitch_accent.drop})</span></p>`),e.counter&&s.push(`<p><strong>Counter:</strong> <span lang="ja">\u301C${r(V(e.counter))}</span></p>`),e.register&&s.push(`<p><strong>Register:</strong> <span class="vocab-register-tag">${r(e.register)}</span></p>`),e.transitivity&&s.push(`<p><strong>Transitivity:</strong> ${r(e.transitivity)}${e.pair_id?` <span class="muted small">(pair: ${r(e.pair_id)})</span>`:""}</p>`),e.register_chain_id&&S[e.register_chain_id]&&s.push(E(e)),s.join("")})()}
      </section>
      ...
      <section>
        ...
        ${m.length?`
          <ol class="example-list">
            ${m.map(s=>`
              <li>
                <p lang="ja" class="example-ja">${N(s.ja)}</p>
  ...
  `,document.getElementById("mark-known-vocab")?.addEventListener("change",s=>{C.setVocabKnown(e.form,s.target.checked)})}export{G as renderVocabularyDetail,F as renderVocabularyList};
