import"./normalize.js";import*as g from"./storage.js";import{navigateTo as f}from"./router.js";const h=[{v:"\u306E\u3080",g:1,en:"drink"},{v:"\u304B\u3046",g:1,en:"buy"},{v:"\u3044\u304F",g:1,en:"go (irregular \u305F-form)"},{v:"\u3088\u3080",g:1,en:"read"},{v:"\u306F\u306A\u3059",g:1,en:"speak"},{v:"\u304B\u304F",g:1,en:"write"},{v:"\u3042\u3046",g:1,en:"meet"},{v:"\u307E\u3064",g:1,en:"wait"},{v:"\u3068\u308B",g:1,en:"take"},{v:"\u306E\u308B",g:1,en:"ride"},{v:"\u3046\u308B",g:1,en:"sell"},{v:"\u304A\u308F\u308B",g:1,en:"finish (intransitive)"},{v:"\u3059\u308F\u308B",g:1,en:"sit"},{v:"\u3042\u308B",g:1,en:"exist (inanimate)"},{v:"\u308F\u304B\u308B",g:1,en:"understand"},{v:"\u3042\u3089\u3046",g:1,en:"wash"},{v:"\u304A\u3088\u3050",g:1,en:"swim"},{v:"\u3044\u305D\u3050",g:1,en:"hurry"},{v:"\u305F\u3079\u308B",g:2,en:"eat"},{v:"\u307F\u308B",g:2,en:"see"},{v:"\u304A\u304D\u308B",g:2,en:"wake up / get up"},{v:"\u306D\u308B",g:2,en:"sleep"},{v:"\u304A\u3057\u3048\u308B",g:2,en:"teach"},{v:"\u3042\u3051\u308B",g:2,en:"open (transitive)"},{v:"\u3057\u3081\u308B",g:2,en:"close (transitive)"},{v:"\u304A\u308A\u308B",g:2,en:"get off"},{v:"\u3067\u304D\u308B",g:2,en:"can do"},{v:"\u308F\u3059\u308C\u308B",g:2,en:"forget"},{v:"\u304A\u307C\u3048\u308B",g:2,en:"remember"},{v:"\u304B\u308A\u308B",g:2,en:"borrow"},{v:"\u304B\u3048\u308B",g:1,en:"return / go home",except:!0},{v:"\u306F\u3044\u308B",g:1,en:"enter",except:!0},{v:"\u306F\u3057\u308B",g:1,en:"run",except:!0},{v:"\u3057\u308B",g:1,en:"know",except:!0},{v:"\u304D\u308B",g:1,en:"cut",except:!0},{v:"\u3044\u308B",g:1,en:"need (\u8981\u308B)",except:!0},{v:"\u3057\u3083\u3079\u308B",g:1,en:"chatter / speak",except:!0},{v:"\u3059\u3079\u308B",g:1,en:"slip / slide",except:!0},{v:"\u3059\u308B",g:3,en:"do"},{v:"\u304F\u308B",g:3,en:"come"},{v:"\u3079\u3093\u304D\u3087\u3046\u3059\u308B",g:3,en:"study"},{v:"\u308A\u3087\u3053\u3046\u3059\u308B",g:3,en:"travel"}];let s=null,i="teach";const u=.9,p=25;async function w(t){return i==="drill"&&s?d(t):i==="finished"&&s?b(t):m(t)}function m(t){i="teach";const e=g.get("verb-class-last-attempt",null);t.innerHTML=`
  ...
  `,document.getElementById("vc-start").addEventListener("click",()=>{s={queue:$(),idx:0,score:0,misses:[]},i="drill",d(t)})}function $(){const t=h.filter(o=>o.except),e=h.filter(o=>!o.except);v(t),v(e);const r=Math.floor(p*.4),n=[];for(;n.length<p;)n.filter(l=>l.except).length<r&&t.length?n.push({...t[Math.floor(Math.random()*t.length)]}):n.push({...e[Math.floor(Math.random()*e.length)]});return v(n),n}function v(t){for(let e=t.length-1;e>0;e--){const r=Math.floor(Math.random()*(e+1));[t[e],t[r]]=[t[r],t[e]]}return t}function d(t){const e=s.queue[s.idx],r=s.queue.length,n=s.feedback;t.innerHTML=`
    <div class="vc-drill">
  ...
  `,document.getElementById("vc-restart").addEventListener("click",()=>{s=null,i="teach",m(t)}),document.getElementById("vc-back").addEventListener("click",()=>{f("learn")})}function c(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}export{w as renderVerbClass};
