...
- **notes:** Foundation pattern for all polite-form Japanese. Every other polite-form pattern in N5 builds on it.
- **examples:**
  - `[0]` わたしは がくせいです。
    > I am a student.
  - `[1]` わたしは がくせいじゃありません。
...
- **meaning_ja:** わだいの しるし
- **notes:** は is the most-tested particle on JLPT N5. The は vs が distinction is the single most common source of N5 errors.
- **examples:**
  - `[0]` わたしは がくせいです。
    > I am a student.
  - `[1]` これは ほんです。
    > This is a book.
  - `[2]` コーヒーは 飲みますが、にくは たべません。
    > I drink coffee, but I do not eat meat. (contrastive は: marks the contrast between two topics)
  - `[3]` あなたは にほんじんですか。
    > Are you Japanese?
  - `[4]` きのうは あめでした。
    > Yesterday was rainy.
...
- **meaning_ja:** ばしょ・じかん・人を しめす
- **notes:** The に vs で distinction (existence vs action) is a top-3 N5 error source. Always ask: is the verb stative (ある／いる) or active (する／たべる／よむ)?
- **examples:**
  - `[0]` 7時に おきます。
...
- **meaning_ja:** ほかにも おなじだと しめす じょし。「だれも」「なにも」では「ぜんぶ」を あらわす。
- **examples:**
  - `[0]` わたしも がくせいです。
    > I am a student too.
  - `[1]` りんごも バナナも すきです。
...
- **meaning_ja:** 「〜から 〜まで」(はんい)
- **examples:**
  - `[0]` 9時から 5時まで しごとです。
    > Work is from 9 to 5.
  - `[1]` とうきょうから おおさかまで しんかんせんで 行きました。
...
- **examples:**
  - `[0]` コーヒーか おちゃが いいです。
    > Coffee or tea would be good.
  - `[1]` ペンか えんぴつで かいてください。
    > Please write with a pen or pencil.
  - `[2]` あしたか あさってに いきます。
...
- **examples:**
  - `[0]` あした しけんですよ。
    > There's an exam tomorrow, you know.
  - `[1]` それは ちがいますよ。
    > That's wrong (let me tell you).
  - `[2]` おいしいですよ、たべてみてください。
...
- **examples:**
  ...
  - `[1]` あの 人は がくせいですよね。
    > That person is a student, right?
  - `[2]` これで いいですよね。
    > This is OK, right?
...
- **meaning_ja:** 「〜の〜」(めいしの しゅうしょく)
- **notes:** Differentiated from n5-028 (possessive sense). This pattern focuses on noun-modifier の: linking a noun to a role/material/location/possessor relationship. See n5-028 for the pure possessive sense (e.g., わたしの本).
- **examples:**
  - `[0]` 日本語の 先生です。
    > I am a teacher of Japanese. (noun-modifier の: links a topic to a role)
  - `[1]` 木の つくえです。
    > It is a wooden desk. (noun-modifier の: links a material to an object)
  - `[2]` 駅の まえに あります。
    > It is in front of the station. (noun-modifier の: links a location to a positional noun)
  - `[3]` 友だちの たんじょうびです。
...
- **meaning_ja:** 「〜ごろ」(やくの じこく)
- **examples:**
  - `[0]` 3時ごろ あいましょう。
    > Let's meet around 3.
  - `[1]` あした 6時ごろ 行きます。
    > I'll go around 6 tomorrow.
  - `[2]` いつごろ 来ますか。
    > Around when will you come?
...
- **meaning_ja:** 「〜など」
- **examples:**
  - `[0]` りんごや バナナなどを よく 食べます。
    > I often eat apples, bananas, etc.
  - `[1]` ペンや ノートなどを 買いました。
    > I bought pens, notebooks, and so on.
...
- **meaning_ja:** 「こちら-シリーズ」(ていねい)
- **examples:**
  - `[0]` こちらへ どうぞ。
    > This way, please.
  - `[1]` そちらの 本は 100円です。
    > That book (over there by you) is 100 yen.
  - `[2]` どちらが いいですか。
...
- **examples:**
  ...
  - `[1]` こんな 人は はじめてです。
    > I've never met this kind of person before.
...
- **meaning_ja:** 「なんがつ」「なんにち」
- **examples:**
  - `[0]` たんじょうびは なんがつ なんにちですか。
...
- **meaning_ja:** ていねいな かこ ひていけい
- **examples:**
  - `[0]` きのうは ばんごはんを たべませんでした。
    > I didn't eat dinner yesterday.
  - `[1]` せんしゅう がっこうへ いきませんでした。
...
- **meaning_ja:** じしょけい
- **notes:** Plain form is the BASE for many other patterns: て-form, た-form, ない-form, conditional, etc.
- **examples:**
  - `[0]` ともだちに あう。
    > [I] meet a friend. (casual)
  - `[1]` まいにち ほんを よむ。
    > [I] read a book every day. (casual)
  - `[2]` あした えいがを みる。
    > [I] will watch a movie tomorrow. (casual)
  - `[3]` べんきょうする じかんが ない。
...
- **meaning_ja:** ふつうの かこ ひてい
- **examples:**
  - `[0]` きのう おさけを のまなかった。
    > [I] didn't drink alcohol yesterday.
  - `[1]` テストに 来なかった。
    > [He] didn't come to the test.
  - `[2]` あさごはんを たべなかった。
...
- **meaning_ja:** ことばを つなぐ どうしの かたち。
- **examples:**
  - `[0]` あさごはんを たべて、がっこうへ 行きます。
    > [I] eat breakfast and go to school.
  - `[1]` ほんを 読んで、ねます。
    > [I] read a book and sleep.
  - `[2]` コーヒーを 飲んで、しごとを します。
    > [I] drink coffee and do work.
  - `[3]` はを みがいて、ねてください。
...
- **meaning_ja:** 「〜て、〜て」
- **examples:**
  - `[0]` あさ おきて、コーヒーを 飲んで、しごとに 行きます。
    > I get up in the morning, drink coffee, and go to work.
  - `[1]` シャワーを あびて、あさごはんを たべて、出かけました。
    > I showered, ate breakfast, and went out.
  - `[2]` ほんを 読んで、ねます。
    > I'll read a book and sleep.
...
- **meaning_ja:** 「〜ています」
- **notes:** しる is the famous exception: しっています (yes) vs しりません (no).
- **examples:**
  - `[0]` いま ごはんを たべています。
...
- **meaning_ja:** 「〜てもいいです」(きょか)
- **examples:**
  - `[0]` ここで しゃしんを とってもいいですか。
...
- **meaning_ja:** 「〜てはいけません」(きんし)
- **examples:**
  - `[0]` ここで たばこを すってはいけません。
    > You must not smoke here.
  - `[1]` じゅぎょうちゅうは 話してはいけません。
    > You must not talk during class.
  - `[2]` ここで しゃしんを とってはいけません。
...
- **examples:**
  - `[0]` あさごはんを たべてから 行きます。
    > I'll go after eating breakfast.
  - `[1]` しごとが おわってから あいましょう。
...
- **meaning_ja:** 「〜ないでください」
- **examples:**
  - `[0]` ここで しゃしんを とらないでください。
    > Please don't take photos here.
  - `[1]` わすれないでください。
    > Please don't forget.
  - `[2]` おおきい こえで 話さないでください。
...
- **meaning_ja:** い-けいようしの ひてい
- **notes:** Memorize the いい → よく irregular: いい / よくない / よかった / よくなかった.
- **examples:**
  - `[0]` この ほんは おもしろくないです。
...
- **meaning_ja:** い-けいようしの かこ ひてい
- **examples:**
  - `[0]` きのうは さむくなかったです。
    > Yesterday wasn't cold.
  - `[1]` その えいがは おもしろくなかったです。
...
- **meaning_ja:** い-けいようし の てけい
- **examples:**
  - `[0]` この りょうりは あつくて、おいしいです。
    > This food is hot and delicious.
  - `[1]` この本は おもしろくて、やすいです。
...
- **meaning_ja:** な-けいようし + です
- **notes:** Watch out for false friends: きれい / きらい / ゆうめい LOOK like い-adjectives but are な-adjectives.
- **examples:**
  - `[0]` この へやは しずかです。
    > This room is quiet.
  - `[1]` あの 人は ゆうめいです。
...
- **meaning_ja:** な-けいようしの かこ
- **examples:**
  - `[0]` きのうの コンサートは にぎやかでした。
    > Yesterday's concert was lively.
  - `[1]` むかしは べんりじゃありませんでした。
    > It wasn't convenient in the past.
  - `[2]` あの 人は ゆうめいでしたか。
...
- **meaning_ja:** な-けいようしの かこ ひてい
- **examples:**
  - `[0]` きのうの しけんは かんたんじゃありませんでした。
    > Yesterday's exam wasn't easy.
  - `[1]` その まちは しずかじゃありませんでした。
    > That town wasn't quiet.
  - `[2]` あの 人は しんせつじゃありませんでしたか。
    > Wasn't that person kind?
...
- **meaning_ja:** な-けいようしの てけい
- **examples:**
  - `[0]` この まちは しずかで、きれいです。
    > This town is quiet and clean.
  - `[1]` あの 人は しんせつで、ゆうめいです。
    > That person is kind and famous.
  - `[2]` とうきょうは べんりで、にぎやかです。
    > Tokyo is convenient and lively.
  - `[3]` この りんごは あまくて、すきです。
...
- **meaning_ja:** 「あります」(ものの そんざい)
- **notes:** Plants are treated as inanimate (use あります). The dividing line is animacy - capacity for self-directed motion.
- **examples:**
  - `[0]` つくえの 上に ほんが あります。
...
- **meaning_ja:** 「〜が あります」(イベント・スキル)
- **notes:** For animate possessions (children, pets), use いる/います instead of ある/あります: 子どもが 二人 います ('I have two children'). 「子どもが あります」is non-standard in modern Japanese.
- **examples:**
  - `[0]` あした しけんが あります。
...
- **meaning_ja:** 「AはBより〜です」(ひかく)
- **examples:**
  - `[0]` とうきょうは おおさかより 大きいです。
...
- **meaning_ja:** 「AとBと、どちらが〜ですか」
- **examples:**
  - `[0]` いぬと ねこと、どちらが すきですか。
...
- **examples:**
  - `[0]` 日本語が できます。
    > I can use Japanese. / I'm able to do (in) Japanese.
  - `[1]` りょうりが できますか。
    > Can you cook?
  - `[2]` ばんごはんが できました。
    > Dinner is ready.
...
- **meaning_ja:** 「すうじ + じょすうし」
- **notes:** つ-counter (ひとつ to ここのつ + とお) works for almost anything when in doubt - safe fallback.
- **examples:**
  - `[0]` りんごを ふたつ ください。
...
- **meaning_ja:** 「Object + counter + Verb」(ごじゅん)
- **notes:** Counter readings often involve rendaku: 三本 reads さんぼん, 一本 reads いっぽん, 六本 reads ろっぽん. See the Counters reference module for full reading patterns.
- **examples:**
  - `[0]` りんごを ふたつ かいました。
    > I bought 2 apples.
  - `[1]` ビールを 3本 ください。
...
- **examples:**
  - `[0]` 7時に おきます。
    > I get up at 7 o'clock.
  - `[1]` 9時に かいぎが あります。
    > There's a meeting at 9 o'clock.
  - `[2]` 何時に きましたか。
...
- **meaning_ja:** 「〜あと」
- **examples:**
  - `[0]` しごとの あとで のみに 行きました。
    > I went for drinks after work.
...
- **meaning_ja:** 「それから」
- **examples:**
  - `[0]` シャワーを あびました。それから、ねました。
    > I showered. After that, I went to bed.
...
- **meaning_ja:** はんたいの ことを 言う つなぎことば。
- **examples:**
  - `[0]` コーヒーが すきです。でも、おちゃは すきじゃありません。
    > I like coffee. But I don't like tea.
...
- **examples:**
  - `[0]` あたまが いたいので、休みます。
    > I have a headache, so I'll rest.
  - `[1]` 今日は 雨なので、行きません。
...
- **meaning_ja:** 「Verb-plain + N」(かんけい-clause)
- **examples:**
  - `[0]` わたしが 買った 本
    > the book I bought
  - `[1]` 友だちが 来る 日
...
- **meaning_ja:** 「〜ながら」
- **notes:** Borderline N5/N4.
- **examples:**
  - `[0]` おんがくを 聞きながら べんきょうします。
...
- **meaning_ja:** 「いつも・たいてい・たまに」
- **examples:**
  - `[0]` いつも 7時に おきます。
    > I always wake up at 7.
  - `[1]` たいてい うちで ごはんを たべます。
...
- **examples:**
  ...
  - `[2]` お水を 二つ おねがいします。
    > Two waters, please.
  - `[3]` 日本語の 本を おねがいします。
    > A Japanese-language book, please.
  - `[4]` もう いちど おねがいします。
...
- **meaning_ja:** 「question word + か / も」
- **notes:** Both どこへも and どこにも occur in negative sentences. どこへも emphasises motion ('not going anywhere'); どこにも emphasises location ('not present anywhere'). At N5, treat them as interchangeable for negative sentences.
- **examples:**
  - `[0]` どこかへ いきたいです。
